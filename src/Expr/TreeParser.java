...
public class TreeParser {
                    ...
                    if (!vecNode.getText().equals("VEC")) {
                        if (type != null) {
                            if (type.equals("bool") || type.equals("i32") || type.equals("& bool") || type.equals("& i32")) {
                                tds.ajouterVariable(name, mut, type, value, pointeur, false, TreeParser.getDeplacement(name, type),offsets);
                            } else {
        ...
        switch (s) {
            ...
            default:
                ...
                if (isInteger(t.getText()))
                    ...
                    return "bool";
                else if((variable = tds.getVariable(tds, t.getText(), false)) != null)
                        ...
                        try {
                            ...
                            if (t.getChildCount() == 0)
                                try {
                                    ...
                                    isSameType(name, "i32", findType(variable2));
    ...
    public static int getDeplacement(String name, String type) {
        if (type != null) {
            if (type.equals("i32")) {
                return 4;
